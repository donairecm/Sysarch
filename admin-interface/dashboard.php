...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="js/profile-dropdown.js" defer></script>
        <script type="text/javascript" src="js/navbar-icons-tooltip.js" defer></script>

        <!-- #region Dashboard scripts-->
        <script type="text/javascript" src="js/dashboard/top_row-graph.js" defer></script>
        <script type="text/javascript" src="js/dashboard/inventory_levels.js" defer></script>
        <script type="text/javascript" src="js/dashboard/recent_orders.js" defer></script>
        <script type="text/javascript" src="js/dashboard/user_activities.js" defer></script>
        <!-- #endregion -->
...
<body>
            ...
            <li class="has-submenu">
                <a class="sidebar-item" href="html/staff/staff.html">
                    <div class="left">
                        ...
                        <span class="sidebar-hover">Staff</span>
                    </div>
                    <div class="right">
                        <svg class="sidebar-hover" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                            <path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/>
    ...
    <nav id="navbar">
        <div class="title">
            <div class="navbarleft">
                ...
                <div class="no-1">Admin Dashboard</div>
            </div>
        </div>
        <div class="icon-container">
            <div class="left-container">
                ...
                <!--<div class="user-activities-container">
                    ...
                    <span class="uac1">User</span>
                    <span class="uac2">Activities</span>
                </div>-->
                <!-- #endregion--> 
                <!-- #region Old Icons -->
                <!--<div class="ic-container" data-tooltip="User Activities">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
                        <path d="M120-200q-33 0-56.5-23.5T40-280v-400q0-33 23.5-56.5T120-760h400q33 0 56.5 23.5T600-680v400q0 33-23.5 56.5T520-200H120Zm0-146q44-26 94-40t106-14q56 0 106 14t94 40v-334H120v334Zm200 26q-41 0-80 10t-74 30h308q-35-20-74-30t-80-10Zm0-110q-45 0-77.5-32.5T210-540q0-45 32.5-77.5T320-650q45 0 77.5 32.5T430-540q0 45-32.5 77.5T320-430Zm0-74q15 0 25.5-10.5T356-540q0-15-10.5-25.5T320-576q-15 0-25.5 10.5T284-540q0 15 10.5 25.5T320-504Zm360 304v-560h80v560h-80Zm160 0v-560h80v560h-80ZM320-540Zm0 260Z"/>
                    </svg>
                </div>
                ...
                <div class="ic-container" data-tooltip="Activities">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
    ...
    <div class="dashboard-grid">
        <div class="dashboard-item total-units-sold top-row" data-modal="total-units-sold">    
            <div class="left">
                <div class="right">
                    <div class="container">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed" class="units-sold-icon">
        ...
        <div class="dashboard-item total-sales top-row" data-modal="total-sales">
        <div class="left">
            <div class="right">
                <div class="container">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
                ...
                <div class="val"><span>₱</span>336,413</div>
                </div>
            </div>
        </div>
        <div class="right"> 
        ...
        <div class="dashboard-item stock-value top-row" data-modal="stock-value">
            <div class="left">
                <div class="right">
                    <div class="container">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
                    ...
                    <div class="container-r">
                        <div class="name">Total Stock Value</div>
                    <div class="val">
                        <span>₱</span>43,413</div>
                    </div>
                </div>
            </div>
            <div class="right"> 
        ...
        <div class="dashboard-item inventory-levels">
            <span class="item-name">Stock Levels</span>
            <div class="container">
                <!-- Filter Buttons -->
                <div id="inventoryFilterButtons">
                    <button class="inventory-filter-btn" data-threshold="high" style="background-color: #28A745;">High Stock</button>
                    <button class="inventory-filter-btn" data-threshold="normal" style="background-color: #007BFF;">Normal Stock</button>
                    <button class="inventory-filter-btn" data-threshold="low" style="background-color: #FFCC00;">Low Stock</button>
                    <button class="inventory-filter-btn" data-threshold="critical" style="background-color: #FF9900;">Critical Stock</button>
                    <button class="inventory-filter-btn" data-threshold="out" style="background-color: #FF4D4D;">Out of Stock</button>
                </div>
                <!-- Chart Canvas -->
                <canvas id="inventoryLevelsChartNew"></canvas>
            </div>
        </div>
        
        
        <div class="dashboard-item user-activities">
            <span class="item-name">User Activities</span>
        
            <div class="user-activities-container">
                <ul class="user-activities-list">
                    <li class="user-activities-header">
                        <span class="user-activities-header-user">User</span>
                        <span class="user-activities-header-name">Name</span>
                        <span class="user-activities-header-time">Time</span>
                        <span class="user-activities-header-activity-log">Activity/Log</span>
                    </li>
