...
<body>
    <nav id="sidebar">
        ...
        <ul>
            ...
            <li class="has-submenu active">
                <a class="sidebar-item" href="staff.php">
                    <div class="left">
                        <div class="icon-container">
                            <svg class="sidebar-hover" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
    ...
    <div class="options-grid">
        <div class="options-grid-item option1">
            <a href="../staff/user-profiles/user-profiles.php">
               <span class="item-name">User Profiles</span>
            </a>
        </div>

        <div class="options-grid-item option2">
            <a href="../staff/activity-logs/activity-logs.php">
