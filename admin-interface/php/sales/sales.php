...
<body>
    ...
    <div class="options-grid">
        <div class="options-grid-item option1">
            <a href="../sales/sales-overview/sales-overview.php">
               <span class="item-name">Sales Overview</span>
            </a>
        </div>

        <div class="options-grid-item option2">
            <a href="../sales/manage-orders/manage-orders.php">
                <span class="item-name">Manage Orders</span>
            </a>
        </div>
        <div class="options-grid-item option3">
            <a href="../sales/customer-details/customer-details.php">
