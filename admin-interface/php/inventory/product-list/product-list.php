...
<html lang="en">
    <head>
        ...
        <!-- #region Inventory-product-list css-->
        <link rel="stylesheet" href="../../../css/inventory/inventory.css">
        <link rel="stylesheet" href="../../../css/inventory/product-list/product-list.css">
         <!-- #endregion -->

        <!-- #region Inventory-product-list scripts-->
        <script type="text/javascript" src="../../../js/inventory/product-list/product-list.js" defer></script>
        <!-- #endregion -->
...
<body>
    ...
    <div class="dashboard-grid">
        <div class="dashboard-item title">Product List</div>
    <div class="dashboard-item product-list"></div>
    </div>
